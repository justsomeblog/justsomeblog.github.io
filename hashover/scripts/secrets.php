<?php
	...
	$encryption_key		= 'ab1cd2ef3';			// Unique 8 to 32 character encryption key
	$notification_email	= 'richard.su@rns.cc';	// E-mail for notification of new comments
	$admin_nickname		= 'PlanePaper';			// Nickname with admin rights (must be title-cased)
	$admin_password		= 'ab1cd2ef3';			// Password to gain admin rights
